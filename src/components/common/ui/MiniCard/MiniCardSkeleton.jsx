export function MiniCardSkeleton() {
  return (
    ...
    <div className='rounded-3xl bg-zinc-900/60 ring-1 ring-white/5 px-4 py-6 lg:px-10 lg:py-10 animate-pulse'>
      <div className='flex flex-col gap-8 lg:gap-45 space-y-2'>
        <div className='flex flex-col gap-3'>
          <div className='h-5 lg:h-7 w-2/5 rounded bg-zinc-800' />
          <div className='h-5 lg:h-7 w-6/7 lg:w-9/10 rounded bg-zinc-800' />
        </div>
